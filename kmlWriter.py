...
class Application(tk.Frame):
    ...
    def nameSelect(self):
        ...
        self.nameList.grid(column=0, row=1, ipadx=5)
    ...
    def lonScrollBar(self):
        ...
        self.lonScroll.grid(column=5, row=1, sticky=tk.W + tk.N + tk.S)      
    
    def quitButton(self):
        self.quit = tk.Button(self, text='Quit', command=self.quit, bg="#005DCD", relief=tk.FLAT, )
        self.quit.grid(column=0, row=2, pady=15)  
